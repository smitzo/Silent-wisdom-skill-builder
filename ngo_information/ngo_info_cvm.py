...
#image
frame1 = os.getcwd()+"/assets/ngo_information/Ngos_special schools.png"
        ...
        for event in pygame.event.get():
            if event.type==pygame.QUIT:
                ...
                if l1.rect.collidepoint(event.pos):
                    webbrowser.open("https://www.deafmuteschool.com/")
                    done = True
                if l2.rect.collidepoint(event.pos):
                    webbrowser.open("https://www.shiksha.com/college/shri-shah-k-l-institute-for-the-deaf-trust-teachers-training-college-bhavnagar-119171")
                    done = True
                if l3.rect.collidepoint(event.pos):
                    webbrowser.open("https://visionpublictrust.org/")
                    done = True
                if l4.rect.collidepoint(event.pos):
                    webbrowser.open("https://www.mookbadhirvikastrustsurat.org/")
                    done = True
                if l5.rect.collidepoint(event.pos):
                    webbrowser.open("https://targetstudy.com/school/schools-for-gifted-children-schools-in-gujarat.html")
                    done = True
