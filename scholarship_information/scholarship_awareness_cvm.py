...
#image
frame1 = os.getcwd()+"/assets\scholarship_information\scholarships_schemes.png"
        ...
        for event in pygame.event.get():
            if event.type==pygame.QUIT:
                ...
                if s1_button.rect.collidepoint(event.pos):
                    webbrowser.open("https://sje.gujarat.gov.in/dsd/downloads/scholarship_04082018.pdf")
                if s2_button.rect.collidepoint(event.pos):
                    webbrowser.open("https://punarbhava.in/index.php/9-legal-instruments/456-gujarat-state-schemes")
                if s3_button.rect.collidepoint(event.pos):
                    webbrowser.open("https://www.bahushrutfoundation.org/")
                if s4_button.rect.collidepoint(event.pos):
                    webbrowser.open("http://akshartrust.com/contact-us.php")
                if s5_button.rect.collidepoint(event.pos):
                    webbrowser.open("https://www.nhfdc.nic.in/scholarship.html")
                if c1_button.rect.collidepoint(event.pos):
                    webbrowser.open("https://www.myscheme.gov.in/schemes/nhis")
                if c2_button.rect.collidepoint(event.pos):
                    webbrowser.open("https://www.myscheme.gov.in/schemes/sak-dip")
                if c3_button.rect.collidepoint(event.pos):
                    webbrowser.open("https://www.myscheme.gov.in/schemes/csss-cus")
                if c4_button.rect.collidepoint(event.pos):
                    webbrowser.open("https://www.myscheme.gov.in/schemes/makats")
